...
%     scatter(2,mean(temp2),28,"filled","MarkerFaceColor",[0.4940 0.1840 0.5560])
%     ee=std(temp2)/sqrt(size(temp2,1));
%     plot([2,2],mean(temp2)+[ee,-ee],"Color",[0.8500 0.3250 0.0980])
% 
%     scatter(3,mean(temp3),28,"filled","MarkerFaceColor",[0.4940 0.1840 0.5560])
%     ee=std(temp3)/sqrt(size(temp3,1));
%     plot([3,3],mean(temp3)+[ee,-ee],"Color",[0 0.4470 0.7410])
% 
%     scatter(4,mean(temp4),28,"filled","MarkerFaceColor",[0.4940 0.1840 0.5560])
%     ee=std(temp4)/sqrt(size(temp4,1));
%     plot([4,4],mean(temp4)+[ee,-ee],"Color",[0.4660 0.6740 0.1880])
