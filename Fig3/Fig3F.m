...
MZ.MZ_cp=MZ_cp
clear MZ_cp
load('m251018TryThePairewiseSimilaryDistanceMat_xm_ACC.mat', 'MZ_cp')% changed here
XM.MZ_cp=MZ_cp
clear MZ_cp
...
[rho,p3]=corr(collect1(:,5),collect1(:,1));text(0.01,0.2,['rho=',num2str(round(rho,3)),' p=',num2str(round(p,3))])
xlim([0 0.2])
%ylim([-0.5 1])
